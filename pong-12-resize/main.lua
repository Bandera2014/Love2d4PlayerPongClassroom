...
function love.load()
     ...
     --setting up a sound table....  Python=Dictionary   Java=Map
     sounds = {
          --['key'] = value
...
--runs anytime that the window's size has been manipulated
function love.resize(w,h)
     push:resize(w,h)         --update the virtual resolution
end
